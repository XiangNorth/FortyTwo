...
export default function Footer() {
    return (
        <>
            <footer className="footer p-10 bg-base-200 border-t border-base-300 text-base-content justify-between">
                <div>
                    <span className="footer-title">Product</span>
                    <a className="link link-hover">42 理念</a>
                    <a className="link link-hover">TOKEN</a>
                    <a className="link link-hover">股东信</a>
                    <a className="link link-hover">隐私协议</a>
                    <a className="link link-hover">功能池</a>
                    <a className="link link-hover">Bug 反馈</a>
                </div>
                <div>
                ...
                <div>
                    ...
                    <a className="link link-hover">为什么要做 42</a>
                    <a className="link link-hover">聊一聊 Web3</a>
                    <a className="link link-hover">42 为什么叫 42</a>
                </div>
                <div>
                    <span className="footer-title">Team</span>
                    <a className="link link-hover">我们是谁</a>
            ...
            <footer className="footer p-10 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    <Image width='60' height="60" src="/logo.webp" priority alt="42 Logo" />
